...
describe('buildChatRequestBody', () => {
  it('默认参数：只送 model/messages/stream + include_usage', () => {
  ...
  it('serviceTier 有值时带 service_tier；空字符串不送', () => {
...
describe('chatCompletion（非流式）', () => {
  beforeEach(() => mockPost.mockReset())

  it('回传 content/reasoning/usage/meta/rawResponse', async () => {
    const api = {
...
describe('chatCompletionStream', () => {
  ...
  it('累積 delta、记 meta、从 usage chunk 取 usage、回呼 onFirstToken/onDelta', async () => {
    feedEvents([
  ...
  it('malformed chunk 忽略不中断', async () => {
